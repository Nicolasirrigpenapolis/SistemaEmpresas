...
using SistemaEmpresas.Features.Dashboard.Dtos;
using SistemaEmpresas.Features.Vendas.Dtos;
using SistemaEmpresas.Features.Compras.Dtos;
using SistemaEmpresas.Models;

namespace SistemaEmpresas.Features.Dashboard.Controllers;
