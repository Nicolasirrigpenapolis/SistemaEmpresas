...
namespace SistemaEmpresas.Features.Fiscal.Repositories;
...
public interface IClassTribRepository
{
    ...
    Task<List<SistemaEmpresas.Features.Fiscal.Controllers.CstOption>> GetCstsAsync();
    Task<SistemaEmpresas.Features.Fiscal.Controllers.ClassTribEstatisticas> GetEstatisticasAsync();
...
public class ClassTribRepository : IClassTribRepository
{
    ...
    public async Task<List<SistemaEmpresas.Features.Fiscal.Controllers.CstOption>> GetCstsAsync()
    {
        ...
        var csts = await _context.ClassTribs
            ...
            .Select(g => new SistemaEmpresas.Features.Fiscal.Controllers.CstOption
            {
    ...
    public async Task<SistemaEmpresas.Features.Fiscal.Controllers.ClassTribEstatisticas> GetEstatisticasAsync()
    {
        ...
        var stats = new SistemaEmpresas.Features.Fiscal.Controllers.ClassTribEstatisticas
        {
