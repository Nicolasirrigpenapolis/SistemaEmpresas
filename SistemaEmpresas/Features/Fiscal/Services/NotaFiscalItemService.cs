...
namespace SistemaEmpresas.Features.Fiscal.Services
{
    ...
    public class NotaFiscalItemService
    {
        ...
        /// </summary>
        public ProdutoDaNotaFiscalCreateDto ConverterParaProdutoDto(
            DadosProcessamentoItem dados, 
            ResultadoCalculo resultado)
        {
            return new ProdutoDaNotaFiscalCreateDto
            {
        ...
        /// </summary>
        public ConjuntoDaNotaFiscalCreateDto ConverterParaConjuntoDto(
            DadosProcessamentoItem dados, 
            ResultadoCalculo resultado)
        {
            return new ConjuntoDaNotaFiscalCreateDto
            {
        ...
        /// </summary>
        public PecaDaNotaFiscalCreateDto ConverterParaPecaDto(
            DadosProcessamentoItem dados, 
            ResultadoCalculo resultado)
        {
            return new PecaDaNotaFiscalCreateDto
            {
