...
namespace SistemaEmpresas.Features.NotaFiscal.Repositories;
...
public class NotaFiscalRepository : INotaFiscalRepository
{
    ...
    public async Task<NotaFiscalModel> CriarAsync(NotaFiscalCreateUpdateDto dto, string usuario)
    {
    ...
    public async Task<NotaFiscalModel?> AtualizarAsync(int id, NotaFiscalCreateUpdateDto dto, string usuario)
    {
    ...
    /// </summary>
    public async Task<NotaFiscalModel> DuplicarAsync(int notaFiscalId, string usuario)
    {
