...
[PrimaryKey("SequenciaDoOrcamento", "SequenciaConjuntoOrcamento")]
[Table("Conjuntos do Orçamento")]
public partial class ConjuntoDoOrcamento
{
    [Key]
    ...
    [Key]
    [Column("Seqüência Conjunto Orçamento")]
    public int SequenciaConjuntoOrcamento { get; set; }
    ...
    [InverseProperty("ConjuntosDoOrcamentos")]
