...
[PrimaryKey("SequenciaDoPedido", "SequenciaDoConjuntoPedido")]
[Table("Conjuntos do Pedido")]
public partial class ConjuntoDoPedido
{
    [Key]
    ...
    [Key]
    [Column("Seqüência do Conjunto Pedido")]
    public int SequenciaDoConjuntoPedido { get; set; }
    ...
    [InverseProperty("ConjuntosDoPedidos")]
