...
[PrimaryKey("SequenciaDaNotaFiscal", "SequenciaDaPecaNotaFiscal")]
[Table("Peças da Nota Fiscal")]
public partial class PecaDaNotaFiscal
{
    [Key]
    ...
    [Key]
    [Column("Seqüência da Peça Nota Fiscal")]
    public int SequenciaDaPecaNotaFiscal { get; set; }
    ...
    [InverseProperty("PecasDaNotaFiscals")]
