...
[PrimaryKey("SequenciaDaOrdemDeServico", "SequenciaPecasOs")]
[Table("Peças da Ordem de Serviço")]
public partial class PecaDaOrdemDeServico
{
    [Key]
    ...
    [Key]
    [Column("Seqüência Peças OS")]
    public int SequenciaPecasOs { get; set; }
    ...
    [InverseProperty("PecasDaOrdemDeServicos")]
