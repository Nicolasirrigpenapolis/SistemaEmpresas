...
[PrimaryKey("SequenciaDaNotaFiscal", "SequenciaProdutoNotaFiscal")]
[Table("Produtos da Nota Fiscal")]
public partial class ProdutoDaNotaFiscal
{
    [Key]
    ...
    [Column("Base de Cálculo da Importação", TypeName = "decimal(11, 2)")]
    public decimal BaseDeCalculoDaImportacao { get; set; }

    [Column("Valor das Despesas Aduaneiras", TypeName = "decimal(11, 2)")]
    public decimal ValorDasDespesasAduaneiras { get; set; }

    [Column("Valor do Imposto de Importação", TypeName = "decimal(11, 2)")]
    public decimal ValorDoImpostoDeImportacao { get; set; }

    [Column("Valor do IOF", TypeName = "decimal(11, 2)")]
    public decimal ValorDoIof { get; set; }
    ...
    [InverseProperty("ProdutosDaNotaFiscals")]
