...
[PrimaryKey("SequenciaDoOrcamento", "SequenciaDoProdutoOrcamento")]
[Table("Produtos do Orçamento")]
public partial class ProdutoDoOrcamento
{
    [Key]
    ...
    [Key]
    [Column("Seqüência do Produto Orçamento")]
    public int SequenciaDoProdutoOrcamento { get; set; }
    ...
    [InverseProperty("ProdutosDoOrcamentos")]
