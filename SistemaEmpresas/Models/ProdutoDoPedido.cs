...
[PrimaryKey("SequenciaDoPedido", "SequenciaDoProdutoPedido")]
[Table("Produtos do Pedido")]
public partial class ProdutoDoPedido
{
    [Key]
    ...
    [Key]
    [Column("Seqüência do Produto Pedido")]
    public int SequenciaDoProdutoPedido { get; set; }
    ...
    [InverseProperty("ProdutosDoPedidos")]
