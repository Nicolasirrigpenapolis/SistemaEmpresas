...
public interface IClassTribRepository
{
    ...
    Task<List<SistemaEmpresas.Controllers.Fiscal.CstOption>> GetCstsAsync();
    Task<SistemaEmpresas.Controllers.Fiscal.ClassTribEstatisticas> GetEstatisticasAsync();
...
public class ClassTribRepository : IClassTribRepository
{
    ...
    public async Task<List<SistemaEmpresas.Controllers.Fiscal.CstOption>> GetCstsAsync()
    {
        ...
        var csts = await _context.ClassTribs
            ...
            .Select(g => new SistemaEmpresas.Controllers.Fiscal.CstOption
            {
    ...
    public async Task<SistemaEmpresas.Controllers.Fiscal.ClassTribEstatisticas> GetEstatisticasAsync()
    {
        ...
        var stats = new SistemaEmpresas.Controllers.Fiscal.ClassTribEstatisticas
        {
