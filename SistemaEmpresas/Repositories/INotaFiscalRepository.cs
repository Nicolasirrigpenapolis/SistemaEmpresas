...
public interface INotaFiscalRepository
{
    ...
    /// </summary>
    Task<NotaFiscal> CriarAsync(NotaFiscalCreateUpdateDto dto, string usuario);
    
    /// <summary>
    /// Atualiza uma nota fiscal existente
    /// </summary>
    Task<NotaFiscal?> AtualizarAsync(int id, NotaFiscalCreateUpdateDto dto, string usuario);
    ...
    /// </summary>
    Task<NotaFiscal> DuplicarAsync(int notaFiscalId, string usuario);
