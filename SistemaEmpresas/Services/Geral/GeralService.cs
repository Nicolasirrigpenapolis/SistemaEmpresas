...
namespace SistemaEmpresas.Services.Geral;
...
{
    private readonly Repositories.Geral.IGeralRepository _repository;
    private readonly IHttpClientFactory _httpClientFactory;
    private readonly ILogger<GeralService> _logger;

    public GeralService(
        Repositories.Geral.IGeralRepository repository,
